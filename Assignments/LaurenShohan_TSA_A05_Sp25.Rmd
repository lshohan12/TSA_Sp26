...
#additive model - if i add trend seasonal and remainder, i will get my og data
solar_decomp_add <- decompose(solar_ts, type = 'additive')
  #residuals dont look random at all, there is some seasonality and even more so at end
  #forcing smooth seasonal component throughout timeframe of data, but initial years there isnt that much variation - forcing a seasonality in beginning in remainder series that doesnt exist.....
  #the additive not a good rep of ts and that seasonal component is evolving with time and not a sole component - means seaonality is a function of the leg of the series, thus a multi may be better fit
  #can see trend is most relative component of the ts - plot decomp wtih auto plot - trend making up most of og 

wind_decomp_add  <- decompose(wind_ts,  type = 'additive')
  #similar issue with seasonality being small component of the data and seasonality is the largest comp 
...
class notes - 
trend comp same but seasonal comp changed too and not multi with remainder will be 0-1 ??
solar - some sort of level shift in series - the spikes of remainder - level shift of solar geneartion 

wind - see similarity of disturbed in the initial remainder series .. 
...
wind - improved and seasonal comp not as bad?? - shoudlve done multiplicative as well? - weird 
...
solar - really bad and removed seasonality of later years which are most relevant in the anaylsis... big mistake to dot this 
wind - completely messed up seasonality of later years 
...
cleaned it oddly for solar and for wind it didnt do anything 
use tsclean before working on data you can get alot of observations flagged as outliers that arent outliers 
