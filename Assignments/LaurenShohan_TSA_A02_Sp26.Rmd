...
```
This ts plot of total biomas energy production illustrates an increasing trend over the decades, with a stagnant period between 1990-2000 that varied quite alot between 200-300 trillion bto, but then slowy climbed from 2000 onward all the way up to near 500 trillion. 
